...
public class Objective : MonoBehaviour
{
    ...
    {
        m_NotificationHUDManager.OnUpdateObjective(new UnityActionUpdateObjective(this, descriptionText, counterText, false, notificationText));
        m_ObjectiveHUDManger.OnUpdateObjective(new UnityActionUpdateObjective(this, descriptionText, counterText, false, notificationText));
    }
