...
public class ShooterAgent : Unity.MLAgents.Agent
{
   ...
   // public AutonomusInputController autonomusInputController;
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        continousActions[0] = Mathf.Clamp(Input.GetAxisRaw("Mouse X"), -1f, 1f);
        continousActions[1] = Mathf.Clamp(Input.GetAxisRaw("Mouse Y"), -1f, 1f);
        ...
        */
        ...
        /*
         * Discrete Mouse movement
        if (Input.GetAxisRaw("Mouse X") == 0f)
        {
            discreteActions[3] = 0;
        } else if (Input.GetAxisRaw("Mouse X") >= 0f) // right
        {
            discreteActions[3] = 1;
        }
        else if(Input.GetAxisRaw("Mouse X") <= 0f) // left
        {
            discreteActions[3] = 2;
        }
        ...
        {
            discreteActions[4] = 0;
        } else if (Input.GetAxisRaw("Mouse Y") >= 0f) // down
        {
            discreteActions[4] = 1;
        }
        else if(Input.GetAxisRaw("Mouse Y") <= 0f) //up
        {
            discreteActions[4] = 2;
        }
        */
        ...
        //*/
         ...
         /***
          * No longer in use, experiment to get the agent to explore more but the agent would be attracted to that area
          */
